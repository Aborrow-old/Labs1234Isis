...
namespace _1labISIS
{
    public partial class Child : Form
    {
        ...
        public string ini_read(string FileName)
        {
            ...
            string ini1 = ini.Read("App", "Value_button1");
            string ini2 = ini.Read("App", "Value_text");
            string ini3 = ini.Read("App", "Value_button2");
            button1.Text = ini1;
            textBox2.Text += ini2;
            button2.Text = ini3;
            return ini3;
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow r in dataGridView1.Rows) // пока в dataGridView2 есть строки
                {
